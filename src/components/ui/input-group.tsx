...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex h-6 w-full min-w-0 items-center border border-border bg-input/30 transition-colors outline-none has-data-[align=block-end]:border has-[[data-slot=input-group-control]:focus-visible]:border-primary has-[[data-slot=input-group-control]:focus-visible]:ring-[1px] has-[[data-slot=input-group-control]:focus-visible]:ring-primary/30 has-[[data-slot][aria-invalid=true]]:border-destructive has-[[data-slot][aria-invalid=true]]:ring-[1px] has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[textarea]:h-auto",
        className,
      )}
      {...props}
    />
