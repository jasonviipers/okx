...
export const env = createEnv({
  server: {
    ...
    GOOGLE_SEARCH_MODEL: optionalString,
    ...
    MINIO_BUCKET_UPLOADS: optionalString,
    MINIO_BUCKET_EXPORTS: optionalString,
    ...
    SWARM_DIAGNOSTIC_COLLECTION_TIMEOUT_MS: optionalIntegerString,
    SWARM_DIAGNOSTIC_MIN_VOTES: optionalIntegerString,
    SWARM_DIAGNOSTIC_MODEL_TIMEOUTS_MS: optionalString,
    SWARM_DIAGNOSTIC_DISABLED_MODELS: optionalString,
  },
  client: {
  ...
  runtimeEnv: {
    ...
    GOOGLE_SEARCH_MODEL: process.env.GOOGLE_SEARCH_MODEL,
    ...
    MINIO_BUCKET_UPLOADS: process.env.MINIO_BUCKET_UPLOADS,
    ...
    SWARM_DIAGNOSTIC_COLLECTION_TIMEOUT_MS:
      process.env.SWARM_DIAGNOSTIC_COLLECTION_TIMEOUT_MS,
    SWARM_DIAGNOSTIC_MIN_VOTES: process.env.SWARM_DIAGNOSTIC_MIN_VOTES,
    SWARM_DIAGNOSTIC_MODEL_TIMEOUTS_MS:
      process.env.SWARM_DIAGNOSTIC_MODEL_TIMEOUTS_MS,
    SWARM_DIAGNOSTIC_DISABLED_MODELS:
      process.env.SWARM_DIAGNOSTIC_DISABLED_MODELS,
