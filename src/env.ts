...
export const env = createEnv({
  server: {
    ...
    PGCONNECT_TIMEOUT: optionalIntegerString,
    MINIO_ENDPOINT: optionalUrl,
    MINIO_ACCESS_KEY: optionalString,
    MINIO_SECRET_KEY: optionalString,
    MINIO_BUCKET_TELEMETRY: optionalString,
    MINIO_BUCKET_BACKUPS: optionalString,
    MINIO_BUCKET_MARKET_DATA: optionalString,
    ...
    AUTONOMOUS_TIMEFRAME_SELECTION: z.enum(autonomousSelectionModes).optional(),
    AUTONOMOUS_TIMEFRAMES: optionalString,
  ...
  runtimeEnv: {
    ...
    PGCONNECT_TIMEOUT: process.env.PGCONNECT_TIMEOUT,
    MINIO_ENDPOINT: process.env.MINIO_ENDPOINT,
    MINIO_ACCESS_KEY: process.env.MINIO_ACCESS_KEY,
    MINIO_SECRET_KEY: process.env.MINIO_SECRET_KEY,
    MINIO_BUCKET_TELEMETRY: process.env.MINIO_BUCKET_TELEMETRY,
    MINIO_BUCKET_BACKUPS: process.env.MINIO_BUCKET_BACKUPS,
    MINIO_BUCKET_MARKET_DATA: process.env.MINIO_BUCKET_MARKET_DATA,
    ...
    AUTONOMOUS_TIMEFRAME_SELECTION: process.env.AUTONOMOUS_TIMEFRAME_SELECTION,
    AUTONOMOUS_TIMEFRAMES: process.env.AUTONOMOUS_TIMEFRAMES,
